...
gem 'europeana-styleguide', github: 'europeana/europeana-styleguide-ruby', ref: '15c783'
...
gem 'europeana-api', github: 'europeana/europeana-api-client-ruby', ref: '11ab8c7'
gem 'feedjira', '~> 2.0'
gem 'fog', '~> 1.33'
gem 'globalize', '~> 5.0'
