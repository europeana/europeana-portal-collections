...
gem 'europeana-styleguide',
  github: 'europeana/europeana-styleguide-ruby', ref: '4d27bb032f'
...
gem 'europeana-blacklight', '~> 0.2.8'
gem 'europeana-api', github: 'europeana/europeana-api-client-ruby', ref: '8ed3bd3'
gem 'feedjira', '~> 2.0'
gem 'fog', '~> 1.33'
