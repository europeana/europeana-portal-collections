...
gem 'europeana-styleguide', github: 'europeana/europeana-styleguide-ruby', ref: '5d8efb9'
...
group :production do
  gem 'europeana-logging', '~> 0.2.2', github: 'europeana/europeana-logging-ruby', branch: 'develop'
