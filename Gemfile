...
gem 'europeana-styleguide', github: 'europeana/europeana-styleguide-ruby', ref: '7127fb'
...
gem 'europeana-api', github: 'europeana/europeana-api-client-ruby', ref: 'd8b9ab0'
gem 'feedjira', '~> 2.0'
gem 'fog', '~> 1.33'
gem 'globalize', '~> 5.0'
