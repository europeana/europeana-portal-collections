...
gem 'europeana-styleguide', github: 'europeana/europeana-styleguide-ruby', ref: '4be4545'
...
gem 'europeana-api', '~> 0.4.1', github: 'europeana/europeana-api-client-ruby', ref: '4c12c58'
gem 'feedjira', '~> 2.0'
gem 'fog', '~> 1.33'
gem 'globalize', '~> 5.0'
