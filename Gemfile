...
gem 'europeana-styleguide', github: 'europeana/europeana-styleguide-ruby', ref: '31e55e5'
...
gem 'devise', '~> 3.5'
gem 'europeana-blacklight', path: '/home/rwdit/dev/euf/git/europeana-blacklight', github: 'europeana/europeana-blacklight', ref: 'b5c488a'
gem 'europeana-api', path: '/home/rwdit/dev/euf/git/europeana-api-client-ruby', github: 'europeana/europeana-api-client-ruby', ref: '16ac267'
gem 'feedjira', '~> 2.0'
gem 'fog', '~> 1.33'
gem 'globalize', '~> 5.0'
