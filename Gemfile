...
gem 'europeana-styleguide', github: 'europeana/europeana-styleguide-ruby', ref: '504123e'
...
gem 'devise', '~> 3.5.4'
gem 'europeana-blacklight', '~> 0.4.3', github: 'europeana/europeana-blacklight', branch: 'release/v0.4.4'
