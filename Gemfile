...
gem 'europeana-styleguide', github: 'europeana/europeana-styleguide-ruby', ref: '2321e1f'
...
gem 'devise', '~> 3.5'
gem 'europeana-blacklight', '~> 0.3.2', github: 'europeana/europeana-blacklight', ref: 'f430d66'
