...
ActiveRecord::Schema.define(version: 20170821115220) do
  ...
  add_index "group_elements", ["groupable_type", "groupable_id", "element_group_type", "element_group_id", "position"], name: "index_groupables_on_group_position", unique: true, using: :btree
