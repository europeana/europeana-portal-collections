...
module BlacklightConfig
  ...
  included do
    ...
    configure_blacklight do |config|
      ...
      # Standard blacklight would use the config.add_show_field method to determine
      # what metadata is displayed on object pages, however within euroeana these configs are not used
      #
