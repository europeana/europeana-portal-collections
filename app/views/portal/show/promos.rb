    ...
    module Promos
      ...
      def js_var_enabled_promos
        promos = [
          ...
          { id: 'exhibition', url: document_exhibition_url(document, format: 'json'), relation: entity_promo_relation('exhibition') },
          { id: 'news', url: document_news_url(document, format: 'json') }
        ] + entity_promos
