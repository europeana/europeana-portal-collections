...
RSpec.describe GalleryImage do
  ...
  it { is_expected.to allow_values('/123/abc', '/123/abc').for(:europeana_record_id) }
  it { is_expected.not_to allow_values('123/abc', 'record/123/abc', 'http://www.europeana.eu/').for(:europeana_record_id) }

  describe '#europeana_record' do
    let(:europeana_record_id) { '/123/abc' }
